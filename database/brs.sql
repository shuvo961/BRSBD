...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 31, 2021 at 01:38 PM
...
INSERT INTO `districts` (`id`, `division_id`, `name`, `bn_name`, `url`) VALUES
...
(14, '2021_08_29_142608_create_divisions_table', 1),
(15, '2021_08_29_142815_create_districts_table', 1),
(16, '2021_08_29_142834_create_unions_table', 1),
(17, '2021_08_29_142845_create_upazilas_table', 1),
(18, '2021_08_30_090637_create_registraions_table', 1),
(19, '2021_08_30_095231_create_registrations_table', 2);
...
CREATE TABLE `registraions` (
  ...
  `bdate` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `father` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `fnationality` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `fnid` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `mother` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `mnationality` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `mnid` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `presaddress` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Dumping data for table `registraions`
--

INSERT INTO `registraions` (`id`, `division`, `district`, `upazila`, `fname`, `lname`, `gender`, `bdate`, `father`, `fnationality`, `fnid`, `mother`, `mnationality`, `mnid`, `presaddress`, `peraddress`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Chattagram', 'Feni', 'Fulgazi', 'Sabbir', 'Alom', 'Male', '2021-08-20', 'altab', 'tr', '3302204488', 'V', 'fghfgh', '54645', '1730 Mistir Dokan Mor , East Jurain , Dhaka', 'retert', 0, '2021-08-30 03:50:22', '2021-08-30 03:50:22');
...
INSERT INTO `registrations` (`id`, `division`, `district`, `upazila`, `fname`, `lname`, `fullname`, `gender`, `bdate`, `father`, `fnationality`, `fnid`, `mother`, `mnationality`, `mnid`, `presaddress`, `peraddress`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Dhaka', 'Dhaka', 'Dohar', 'Sabbir', 'Alom', 'Sabbir Alom', 'Male', '1997-05-31', 'Zahangir Alom', 'Bangladeshi', '3302204488', 'Shamoly Begum', 'Bangladeshi', '3302252555', '1730 Mistir Dokan Mor , East Jurain , Dhaka', '1730 Mistir Dokan Mor , East Jurain , Dhaka', 1, '2021-08-30', '2021-08-30'),
(12, 'Chattagram', 'Brahmanbaria', 'Akhaura', 'Victoria D', 'Norris', 'Victoria D Norris', 'Male', '2021-08-14', 'ert', 'Bangladeshi', '1234', 'V', 'dfssdf', '545', '4797 Roosevelt Road', 'fgyfgy', 1, '2021-08-30', '2021-08-31');
...
(1, 'Sabbir Alom', 'admin@brsbd.com', NULL, '$2y$10$/mGwZD97QPuUuSzyUOXlpOeM2.vxfDWLq8jkTxnyh.jrq4KUs3mEO', NULL, '2021-08-30 11:02:28', '2021-08-30 11:02:28');
...
--
ALTER TABLE `upazilas`
  MODIFY `id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=510;
